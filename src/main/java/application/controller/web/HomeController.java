...
import application.data.service.BannerService;
...
public class HomeController extends BaseController {
    ...
    public String home(Model model,
        ...
        if (categoryId != null) {
            ...
            vm.setKeyWord("Kết quả tìm kiếm của: " + bookName.getName());
        } else {
         ...
         * set list banner
         */
        List<Banner> bannerList = bannerService.getListAllBanners();
        ...
        for (Banner banner : bannerList) {
            ...
            bannerVM.setAltText(banner.getAltText());
            bannerVM.setImageUrl(banner.getImageUrl());
        ...
        vm.setListBanners(bannerVMList);
